...
export const buttonVariants = cva(
  "inline-flex scale-100 items-center justify-center rounded-lg text-sm font-medium ring-offset-background transition-[transform,background-color] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary focus-visible:ring-offset-2 active:scale-95 disabled:pointer-events-none disabled:opacity-50 py-4",
  {
    variants: {
      variant: {
