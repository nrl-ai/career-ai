  ...
  <AccordionItem value="1">
    ...
    <AccordionContent className="prose max-w-none dark:prose-invert">
      ...
      <p>
        ...
        to build the first version of CareerAI in 2019. Since then, it's gone through
        multiple iterations as I've learned a lot of better coding practices over the years.
      </p>

      <p>
        At the time of writing, CareerAI is probably one of the only handful of resume
      ...
      <p>
        ...
        basis, and I'm extremely proud to say that CareerAI, over it's years of development,
  ...
  <AccordionItem value="3">
    ...
    <AccordionContent className="prose max-w-none dark:prose-invert">
      ...
      <p>
        ...
        that's wishful thinking. But if you do mention CareerAI on your blog, let me know so
...
const Question4 = () => {
  ...
  return (
    <AccordionItem value="4">
      ...
      <AccordionContent className="prose max-w-none dark:prose-invert">
        <p>
          Here are the languages currently supported by CareerAI, along with their respective
  ...
  <AccordionItem value="5">
    ...
    <AccordionContent className="prose max-w-none dark:prose-invert">
      <p>
        ...
        me in my everyday work and with the development of CareerAI. It only makes sense that
      ...
      <p>
        ...
        CareerAI has to offer. I would even suggest you to take the extra step of using
        ChatGPT to write your content, and simply copy it over to CareerAI.
      </p>
    </AccordionContent>
  </AccordionItem>
);
