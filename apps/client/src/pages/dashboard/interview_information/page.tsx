...
export const InterviewInformationPage = () => {
  ...
  return (
    <div className="h-screen w-full p-6 flex flex-col justify-between bg-[#f2f2f7]">
      ...
      <div className="grid grid-cols-2 gap-x-6 h-fit flex-cols">
              ...
              <Dropdown
                ...
                pt={{
                  root: {
                    ...
                    className:
                      "focus-within:outline focus-within:outline-1 focus-within:outline-[#007AFF]",
                  },
                  wrapper: {
        ...
        <div className="col-span-1 rounded-[10px] bg-white p-6"></div>
      </div>
      <div className="flex justify-between">
        <button
          type="button"
          className="py-3.5 px-[72px] bg-white rounded-[6px] outline outline-1 outline-[#8E8E93]"
        ...
        <button
          type="button"
          className={`py-3.5 px-[60px] rounded-[6px]  ${(language != "" && position != "" && type != "" && jd != "" && selectedCV != "") === false ? "bg-[#AEAEB2]" : "bg-[#007AFF]"}`}
          disabled={
            (language != "" && position != "" && type != "" && jd != "" && selectedCV != "") ===
            false
              ? true
              : false
          }
