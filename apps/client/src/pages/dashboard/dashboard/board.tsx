...
export function BoardView() {
  ...
  useEffect(() => {
    ...
    if (!loading && (typeof jobApplications === 'object' && !Array.isArray(jobApplications) && jobApplications !== null)) {
  ...
  if (loading || (typeof jobApplications === 'object' && !Array.isArray(jobApplications) && jobApplications !== null)) return <div>Loading...</div>
  return (
