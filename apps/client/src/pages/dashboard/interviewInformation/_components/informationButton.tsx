...
const ListPositionItem = ({name, isOpen} : Props) => {
    return (
        <div className="w-fit px-5 py-2 bg-[#F4F9FF] outline outline-1 outline-[#6B94F9] rounded-md">
            <span className=" text-base text-normal text-[#6B94F9]">{name}</span>
        </div>
    )
};
...
export const InformationButton = () => {
    ...
    return (
        <>
            ...
            <div id="dropdownSearch_1" className="z-50 hidden mt-16 outline outline-1 outline-[#6B94F9] bg-white rounded-lg shadow w-[30rem]">
                <div className="p-3">
            ...
            <button id="dropdownSearchButton_2" data-dropdown-toggle="dropdownSearch_2" data-dropdown-placement="bottom" className="text-[#B3B3B3] outline outline-1 outline-[#B3B3B3] focus:outline-[#6B94F9] font-normal text-base rounded-lg px-2.5 py-2.5 inline-flex items-center justify-between w-[15rem]" type="button" onClick={handleOnClick}>
                Chọn cấp độ
                <svg className="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                </svg>
            ...
            <button id="dropdownSearchButton_4" data-dropdown-toggle="dropdownSearch_4" data-dropdown-placement="bottom" className="text-[#B3B3B3] outline outline-1 outline-[#B3B3B3] focus:outline-[#6B94F9] font-normal text-base rounded-lg px-2.5 py-2.5 inline-flex items-center justify-between w-[250px]" type="button" onClick={handleOnClick}>
                Loại phỏng vấn
                <svg className="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                </svg>
