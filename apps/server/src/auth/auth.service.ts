...
import { AuthProvidersDto, LoginDto, RegisterDto, UserWithSecrets } from "@career-ai/dto";
...
export class AuthService {
  ...
  async forgotPassword(email: string) {
    ...
    const subject = "Reset your CareerAI password";
  ...
  async setup2FASecret(email: string) {
    ...
    const uri = authenticator.keyuri(email, "CareerAI", secret);
